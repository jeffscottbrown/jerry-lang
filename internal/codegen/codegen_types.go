...
var builtinReturnType = map[string]*checker.Type{
	...
	"string_contains":    checker.Bool,
	"string_starts_with": checker.Bool,
	"string_ends_with":   checker.Bool,
	"string_index_of":    checker.Int,
	"string_to_int":      checker.Int,
	"read_bytes":         checker.String,
	...
	"getenv":            checker.String,
	"runtime_lib_path":  checker.String,
	"stdlib_dir_path":   checker.String,
	"is_dir":            checker.Bool,
	"list_dir":          checker.ArrayOf(checker.String),
	"delete_file":       checker.Void,
	"exec":              checker.Int,
